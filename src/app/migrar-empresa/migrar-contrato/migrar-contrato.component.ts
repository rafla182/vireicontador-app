...
@Component({
    selector: 'app-migrar-contrato',
    templateUrl: './migrar-contrato.component.html',
    styleUrls: ['./migrar-contrato.component.css']
})
export class MigrarContratoComponent implements OnInit, AfterViewInit {
    ...
    send(pdfAsString) {
        ...
        this.abrirEmpresaService.sendMigrarContrato(this.base64ArrayBuffer(pdfAsString), this.model.empresa)
            .subscribe(arg => {
                this.trocarTela.emit('migrar-sucesso');
            }
            );
        ;
    }
