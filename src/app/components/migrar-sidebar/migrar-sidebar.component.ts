...
@Component({
    selector: 'app-migrar-sidebar',
    templateUrl: './migrar-sidebar.component.html',
    styleUrls: ['./migrar-sidebar.component.css']
})
export class MigrarSidebarComponent implements OnInit {
    menuItems: any[];
    @Input() tela: any;
